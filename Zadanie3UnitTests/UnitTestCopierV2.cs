...
namespace Zadanie3UnitTests
{
    ...
    public class UnitTestCopierV2
    {
        ...
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        public void Copier_ScanAndPrint_DeviceOn_PrinterOn_ScannerOn()
        {
            var copier = new Copier();
            copier.PowerOn();
            copier.TurnPrinterOn();
        ...
        [TestMethod]
        public void Copier_ScanAndPrint_DeviceOn_PrinterOn_ScannerOff()
        {
            var copier = new Copier();
            copier.PowerOn();
            copier.TurnPrinterOn();
        ...
        [TestMethod]
        public void Copier_ScanAndPrint_DeviceOn_PrinterOff_ScannerOn()
        {
            var copier = new Copier();
            copier.PowerOn();
            copier.TurnScannerOn();
